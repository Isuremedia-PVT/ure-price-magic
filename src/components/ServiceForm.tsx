...
const ServiceForm = ({ open, onOpenChange, serviceData }: ServiceFormProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[1200px] h-[100vh] md:h-auto md:max-h-[90vh] overflow-hidden p-0">
        <div className="flex flex-col md:flex-row h-full md:max-h-[90vh]">
          ...
          {(serviceData.serviceType === "PPC Management" && serviceData.platformBreakdown) || 
           ...
           serviceData.serviceType === "GHL Monthly Retainer" ? (
             <div className="md:w-[40%] bg-[#FFF9F0] border-r border-border flex-shrink-0 max-h-[45vh] md:max-h-none overflow-visible md:overflow-y-auto p-4 md:p-6 border-b md:border-b-0">
