...
const ServiceForm = ({ open, onOpenChange, serviceData }: ServiceFormProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[1200px] h-[100vh] md:h-[90vh] overflow-hidden p-0">
        <div className="flex flex-col md:flex-row h-full">
          ...
          {(serviceData.serviceType === "PPC Management" && serviceData.platformBreakdown) || 
           ...
           serviceData.serviceType === "GHL Monthly Retainer" ? (
             <div className="flex-shrink-0 md:w-[40%] max-h-[40vh] md:max-h-none bg-[#FFF9F0] border-r md:border-r border-b md:border-b-0 border-border overflow-y-visible md:overflow-y-auto p-4 md:p-6">
               <h3 className="text-base md:text-xl font-bold mb-3 md:mb-4" style={{ color: '#000047' }}>
              ...
              {serviceData.serviceType === "PPC Management" && serviceData.platformBreakdown && (
                ...
                <div className="mb-2 md:mb-4">
                  <p className="text-xs md:text-sm font-semibold mb-1 md:mb-2" style={{ color: '#000047' }}>
                    Selected Platform(s):
                  </p>
                ...
                <div className="border-t border-border my-2 md:my-4"></div>

                {/* Total Ad Spend & Allocation */}
                <div className="mb-2 md:mb-4">
                  <p className="text-sm md:text-base font-bold mb-2 md:mb-3" style={{ color: '#000047' }}>
                    Total Ad Spend: ${serviceData.adSpend?.toLocaleString()}/month
                  </p>
                  <p className="text-xs md:text-sm font-semibold mb-1 md:mb-2 text-muted-foreground">
                ...
                <div className="space-y-1 md:space-y-2 mb-2 md:mb-4">
                  ...
                  {serviceData.multiPlatformDiscount && typeof serviceData.multiPlatformDiscount === 'number' && serviceData.multiPlatformDiscount > 0 && (
                    <div className="flex justify-between text-xs md:text-sm font-semibold" style={{ color: '#faa033' }}>
                ...
                <div className="border-t-2 border-border my-2 md:my-4"></div>
                ...
                <div className="space-y-2 md:space-y-3">
                  ...
                  {serviceData.managementPercentage && typeof serviceData.managementPercentage === 'string' && (
                    <p className="text-[10px] md:text-xs text-muted-foreground italic mt-1 md:mt-2">
              ...
              {serviceData.serviceType === "Social Media Management" && serviceData.smmBreakdown && (
                <div className="space-y-3 md:space-y-0">
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <p className="text-xs md:text-sm leading-relaxed" style={{ color: '#000047' }}>
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <div className="space-y-0.5 md:space-y-1 ml-2 text-xs md:text-sm" style={{ color: '#000047' }}>
              ...
              {serviceData.serviceType === "SEO Services" && (
                <div className="space-y-3 md:space-y-0">
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <p className="text-xs md:text-sm" style={{ color: '#000047' }}>
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <div className="ml-4 space-y-1 md:space-y-2">
                      ...
                      <div className="border-t border-border my-1 md:my-2"></div>
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <div className="ml-2 space-y-0.5 md:space-y-1 text-xs md:text-sm" style={{ color: '#000047' }}>
              ...
              {serviceData.serviceType === "GHL Hourly Buildout" && (
                <div className="space-y-3 md:space-y-0">
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <div className="ml-2 space-y-1 md:space-y-2">
                      <div className="flex justify-between text-xs md:text-sm">
              ...
              {serviceData.serviceType === "GHL Sub-Account Support" && (
                <div className="space-y-3 md:space-y-0">
                  ...
                  <div className="mb-2 md:mb-4">
                    ...
                    <p className="text-xs md:text-sm font-bold" style={{ color: '#000047' }}>
          ...
          <div className={`flex-1 ${(serviceData.serviceType === "PPC Management" && serviceData.platformBreakdown) || 
                              (serviceData.serviceType === "Social Media Management" && serviceData.smmBreakdown) ||
                              serviceData.serviceType === "SEO Services" ||
                              serviceData.serviceType === "GHL Client Onboarding" ||
                              serviceData.serviceType === "GHL Hourly Buildout" ||
