...
const PPCCalculator = () => {
  ...
  const handleGetStarted = () => {
    const totalAdSpend = selectedPlatforms.reduce((sum, platform) => sum + (platformBudgets[platform] || 5000), 0);
    ...
    <section id="ppc" className="py-24 gradient-subtle relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div
            className="grid grid-cols-1 lg:grid-cols-[70%_30%] gap-8 max-w-[1400px] mx-auto fade-in-up"
          ...
          >
            ...
            <Card className="shadow-medium hover:shadow-xl border-2 border-border/50 hover:border-primary/20 bg-gradient-card card-hover">
              ...
              <CardContent className="space-y-8">
                <div>
                  <Label className="text-lg font-semibold mb-4 block text-primary">
                    Choose Your Advertising Platform(s)
                  </Label>
                ...
                {selectedPlatforms.length > 0 && (
                  <div className="space-y-5">
                    ...
                    {selectedPlatforms.map((platform) => (
                      <div
                        key={platform}
                        className="glass-card rounded-2xl p-6 border-2 border-border/30 hover:border-primary/30 transition-smooth"
                      >
                  ...
                  {selectedPlatforms.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-base text-muted-foreground font-medium">
                        Please select a platform to see pricing
                      </p>
                    </div>
                  ) : (
                    <>
                      ...
                      <div className="border-t-2 border-accent/30 pt-6 mt-6 gradient-accent-glow -mx-6 px-6 pb-6 rounded-b-lg space-y-5">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-white text-4xl font-bold">${totalMonthlyFee.toLocaleString()}/mo</span>
                        </div>
                        ...
                        {multiPlatformDiscount > 0 && (
                          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 mb-0 border border-white/30">
                            ...
                            <p className="text-white text-sm mt-1">Save $50/mo per additional platform</p>
                          </div>
                        )}
