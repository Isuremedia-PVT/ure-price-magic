    ...
    <section id="ghl" className="py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Buildout & Support Services */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold text-center mb-8">
              GHL Buildout & Support Services
            </h3>
            <Card className="shadow-medium max-w-3xl mx-auto">
              <CardHeader>
                <CardTitle>Custom Buildout Services</CardTitle>
                <CardDescription>
                  Hourly services for custom GoHighLevel setup and configuration
                </CardDescription>
              </CardHeader>
                ...
                <div className="border-t pt-6">
                  <div className="bg-secondary/50 rounded-lg p-6 space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Buildout Hours:</span>
                      <span className="font-semibold">${buildoutCost}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Onboarding Sessions:</span>
                      <span className="font-semibold">${onboardingCost}</span>
                    </div>
                    <div className="border-t pt-3 mt-3">
                      <div className="flex justify-between items-center">
                        <span className="text-lg font-bold">Total Investment:</span>
                        <span className="text-2xl font-bold text-accent">
                          ${(buildoutCost + onboardingCost).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div>
            <h3 className="text-2xl font-bold text-center mb-8">Monthly Support Plans</h3>
