...
const SMMCalculator = () => {
  ...
  return (
    <section id="smm" className="py-20 bg-background-alt">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-primary">Social Media Management</h2>
              ...
              <Card className="shadow-strong border-l-4 border-l-accent border-2 border-accent/30 bg-background-cream">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="border-t-2 border-accent/30 pt-6 mt-6 bg-accent/5 -mx-6 px-6 pb-6 rounded-b-lg">
                    ...
                    <Button variant="hero" size="xl" className="w-full shadow-orange" onClick={handleGetStarted}>
