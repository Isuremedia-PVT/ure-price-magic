              ...
              <Card className="shadow-xl border-2 border-orange-500 bg-white overflow-hidden rounded-lg">
                ...
                <CardContent className="p-6 pt-4 space-y-4 pb-0">
                  ...
                  <div className="border-t-2 border-accent/30 pt-6 mt-6 gradient-accent-glow -mx-6 px-6 pb-6 rounded-b-lg">
                    ...
                    <button className="w-full bg-white text-[#0A1F44] font-bold text-lg py-4 px-6 rounded-lg hover:bg-gray-50 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-2" onClick={() => setFormOpen(true)}>
                      Get Started →
                    </button>
                  </div>
                </CardContent>
